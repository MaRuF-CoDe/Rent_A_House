            ...
            <div class="col-md-9">
               ...
               <?php echo $__env->make('partial.successMessage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>  
                ...
                <div class="card mt-5">
                    ...
                    <a href="<?php echo e(route('admin.area.create')); ?>" class="btn btn-success btn-md float-right c-white">Add new area <i class="fa fa-plus"></i></a>
                    </div>
                    <!-- /.card-header -->
                        ...
                        <tr>
                          ...
                          <td>
                            <?php if($area->user_id == Auth::id()): ?>
                              <a href="<?php echo e(route('admin.area.edit', $area->id)); ?>"  class="btn btn-info">Edit</a>
                            <?php endif; ?>
                          ...
                          <form id="delete-form-<?php echo e($area->id); ?>" action="<?php echo e(route('admin.area.destroy',$area->id)); ?>" method="POST" style="display: none;">
                              <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Rent_A_House\resources\views/admin/area/index.blade.php ENDPATH**/ ?>