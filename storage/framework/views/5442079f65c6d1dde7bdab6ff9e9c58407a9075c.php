...
<div class="container">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 welcome text-center my-4">
            <h1 class="name">Welcome to Landlord Panel - <span style="padding: 6px;color:white;background:grey;"> <?php echo e(Auth::user()->name); ?></span></h1>  
        </div>
    </div>
...
<?php echo $__env->make('layouts.backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Rent_A_House\resources\views/landlord/dashboard.blade.php ENDPATH**/ ?>