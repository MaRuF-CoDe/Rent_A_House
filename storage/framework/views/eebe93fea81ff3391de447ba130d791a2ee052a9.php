    ...
    <div class="row p-3">
        ...
        <div class="col-md-8">
            <div class="table-responsive-md">
                <table class="table">
                    <tr>
                        <a href="<?php echo e(route('landlord.profile.edit', $profile->id)); ?>" class="btn btn-info float-right my-4" >Edit Profile</a>
                    </tr>
                    <tr>
                        <th>Name</th>
...
<?php echo $__env->make('layouts.backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Rent_A_House\resources\views/landlord/profile/index.blade.php ENDPATH**/ ?>