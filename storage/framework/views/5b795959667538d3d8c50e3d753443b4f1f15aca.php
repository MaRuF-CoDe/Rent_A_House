               ...
               <?php echo $__env->make('partial.successMessage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>  
                ...
                <div class="card my-5 mx-4">
                    <div class="card-header">
                      <h3 class="card-title float-left"><strong>Booking Requests (<?php echo e($books->count()); ?>)</strong></h3>
                      ...
                      <table id="dataTableId" class="table table-bordered table-striped table-background">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <button class="btn btn-info btn-sm" type="button" onclick="accept(<?php echo e($book->id); ?>)">
                                Accept
                            </button>
              
                            <form id="accept-form-<?php echo e($book->id); ?>" action="<?php echo e(route('landlord.request.accept', $book->id)); ?>" method="POST" style="display: none;">
                                <?php echo csrf_field(); ?>
                            </form>
                        ...
                        <td>
                           ...
                           <button class="btn btn-danger btn-sm" type="button" onclick="reject(<?php echo e($book->id); ?>)">
                               Reject
                           </button>
             
                           <form id="reject-form-<?php echo e($book->id); ?>" action="<?php echo e(route('landlord.request.reject', $book->id)); ?>" method="POST" style="display: none;">
                               <?php echo csrf_field(); ?>
                           </form>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Rent_A_House\resources\views/landlord/booking/requested.blade.php ENDPATH**/ ?>