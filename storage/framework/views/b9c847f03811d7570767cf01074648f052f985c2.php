...
<div class="container">
        <div class="row justify-content-center">
            <div class="col-md-9">
                <div class="card mt-5">
                    ...
                    <form action="<?php echo e(route('renter.profile.update')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group">
                                ...
                                <a href="<?php echo e(route('renter.profile.show')); ?>" class="btn btn-danger wave-effect" >Back</a>
                        </div>
                  </form>
 ...
 <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Rent_A_House\resources\views/renter/profile/edit.blade.php ENDPATH**/ ?>