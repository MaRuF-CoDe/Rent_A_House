                ...
                <div class="card mt-5">
                    <div class="card-header">
                      <div class="d-flex justify-content-between">
                          ...
                          <div>
                              <a class="btn btn-danger" href="<?php echo e(route('landlord.house.index')); ?>"> Back</a>
                          </div>
                      </div>
                            ...
                            <?php $__currentLoopData = json_decode($house->images); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $picture): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <div class="col-md-3">
                                           <a href="<?php echo e(asset('images/'.$picture)); ?>">
                                                       <img  src="<?php echo e(asset('images/'.$picture)); ?>" class="img-fluid m-2" style="height: 150px;width: 100%; ">
                                           </a>
                                       </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Rent_A_House\resources\views/landlord/house/show.blade.php ENDPATH**/ ?>