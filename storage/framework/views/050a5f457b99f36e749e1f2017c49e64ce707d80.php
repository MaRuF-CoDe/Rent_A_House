...
House Renter - <?php echo e($area->name); ?>
...
<div class="container-fluid">
    <div class="row justify-content-center py-5 area-wise-show">
        <h2 class="text-center">All Available Houses In This Area: <strong><?php echo e($area->name); ?>

                (<?php echo e($houses->count()); ?>)</strong></h2>
        <br>
    </div>
</div>
<div class="container">
        ...
        <div class="col-md-4">
            <div class="card m-3">
                <div class="card-header">
                    <img src="<?php echo e(asset('storage/app/public/featured_house/'. $house->featured_image)); ?>" width="100%"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Rent_A_House\resources\views/areaWiseShow.blade.php ENDPATH**/ ?>