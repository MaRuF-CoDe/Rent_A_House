...
Route::get('/payment/success/{authId}/{houseId}', 'PaymentController@success')->name('payment.success');
Route::get('/payment/error/{houseId}', 'PaymentController@error')->name('payment.error');
